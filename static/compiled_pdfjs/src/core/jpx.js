...
const JpxImage = (function JpxImageClosure() {
    ...
    parseCodestream: function JpxImage_parseCodestream(data, start, end) {
      ...
      try {
        ...
        while (position + 1 < end) {
          ...
          let length = 0; var j; var sqcd; var spqcds; var spqcdSize; var scalarExpounded; var tile;
          switch (code) {
  ...
  function buildCodeblocks(context, subband, dimensions) {
    ...
    for (j = cby0; j < cby1; j++) {
      for (i = cbx0; i < cbx1; i++) {
        ...
        const pi = Math.floor((codeblock.tbx0_ - subband.tbx0) /
          precinctParameters.precinctWidthInSubband);
        const pj = Math.floor((codeblock.tby0_ - subband.tby0) /
  ...
  function PositionComponentResolutionLayerIterator(context) {
    ...
    let l = 0; let r = 0; let c = 0; let px = 0; let
      py = 0;
  ...
  function parseTilePackets(context, data, offset, dataLength) {
    let position = 0;
    let buffer; let bufferSize = 0; let
      skipNextBit = false;
  ...
  function copyCoefficients(coefficients, levelWidth, levelHeight, subband,
    ...
    for (let i = 0, ii = codeblocks.length; i < ii; ++i) {
      ...
      // collect data
      const data = codeblock.data; let totalLength = 0; let
        codingpasses = 0;
      var j, jj, dataItem;
  ...
  function transformTile(context, tile, c) {
    ...
    const transform = (reversible ? new ReversibleTransform()
  ...
  function transformComponents(context) {
    ...
    for (let i = 0, ii = context.tiles.length; i < ii; i++) {
      ...
      const out = new Uint8Array(tile0.items.length * componentsCount);
      const result = {
        left: tile0.left,
        top: tile0.top,
        width: tile0.width,
      ...
      let pos = 0; var j; var jj; var y0; var y1; var y2; var r; var g; var b; var k; var val;
  ...
  var TagTree = (function TagTreeClosure() {
    ...
    TagTree.prototype = {
      reset: function TagTree_reset(i, j) {
        let currentLevel = 0; let value = 0; let
          level;
        ...
        for (let i0 = 0; i0 < height; i0 = iNext) {
          ...
          for (let j = 0; j < width; j++) {
            ...
            let i = i0; var
              sign;
            if (allEmpty) {
              const hasSignificantCoefficent =
  ...
  const Transform = (function TransformClosure() {
    ...
    Transform.prototype.iterate = function Transform_iterate(ll, hl_lh_hh,
        u0, v0) {
      const llWidth = ll.width; const llHeight = ll.height; let
        llItems = ll.items;
